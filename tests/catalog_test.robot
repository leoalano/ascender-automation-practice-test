...
Test case 10 - Click on image "Printed Summer Dress1"
    Given I am at automationpractice.com
     ...
     Then I verify a successful redirect for product page "${P_SUMMER_DRESS_PAGE}"
...
Test case 12 - Click on image "Printed Chiffon Dress"
    Given I am at automationpractice.com
     ...
     Then I verify a successful redirect for product page "${P_CHIFRON_DRESS_PAGE}"
